        ...
        <div className='grid grid-cols-1 bg-gray-50'>
            ...
            <div className='flex flex-col justify-center space-x-4'>
                ...
                <div className=''>
                    ...
                    type="button" className="text-white bg-green-500 hover:bg-green-500 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 md:flex hidden">Publish new blog</button>
            ...
            </div>
            {
                ...
                <div className='justify-center font-semibold '>
                    ...
                    onClick={()=>{
                     ...
                     className='cursor-pointer flex justify-end px-5 text-slate-500 text-lg hover:text-xl hover:text-slate-600 my-1'>My Blogs</div>
                    <div
                        onClick={()=>{
                            localStorage.removeItem("jwt")
                            navigate("/signin")
                         }}
                    className=' cursor-pointer flex justify-end px-5 text-slate-500 text-lg  hover:text-xl hover:text-slate-600'>Logout</div>
                </div>
                : null
            }
